    ...
    <!-- ********** NOOM -  Food Logging ********** -->
      ...
      <li class="folio-item ux graphics featured">
      	<a href="Portfolio/?p=mediago_app">
			...
			<div class="hover-state">
				<div class="folio-hover">
					<span class="folio-title">MediaGo Concept UI</span><br/>
					<span class="folio-type">UI / UX</span>
				</div>
			</div>
		</a>
	  </li>
...
<!--       <li class="folio-item ux">
      	<a href="Portfolio/?p=mediago_new">
			...
			<div class="hover-state">
				<div class="folio-hover">
					<span class="folio-title">MediaGo New Freature</span><br/>
					<span class="folio-type">UI &amp UX</span>
				</div>
			</div>
		</a>
