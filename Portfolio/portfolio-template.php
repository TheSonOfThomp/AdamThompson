...
<figure class="folio_image image" id="img2">
...
<figure class="folio_image image" id="img3">
...
<figure class="folio_image image" id="img4">
...
<figure class="folio_image image" id="img5">
...
<figure class="folio_image video" id="vid1">
	<iframe width="640" height="360" src="<?php echo $p_video1; ?>" frameborder="0" allowfullscreen></iframe>
</figure>

<figure class="folio_image video" id="vid2">
	<iframe width="640" height="360" src="<?php echo $p_video2; ?>" frameborder="0" allowfullscreen></iframe>
</figure>

<figure class="folio_image video" id="vid3">
	<iframe width="640" height="360" src="<?php echo $p_video3; ?>" frameborder="0" allowfullscreen></iframe>
</figure>